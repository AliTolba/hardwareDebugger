...
ServiceManager::ServiceManager(QObject* xParent)
    ...
    , dDesignViewService(&dDesignRepository)
    , dSignalViewService(&dSignalRepository)
    , dAssertionViewService(&dAssertionRepository)
    , dTransactionViewService(&dTransactionRepository)
{
}
